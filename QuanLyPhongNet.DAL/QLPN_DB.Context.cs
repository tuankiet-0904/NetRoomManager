...
namespace QuanLyPhongNet.DAL
{
    ...
    public partial class QuanLyPhongNetDataBase : DbContext
    {
        public QuanLyPhongNetDataBase()
            : base("name=QuanLyPhongNetDataBase")
        {
        }
        ...
        public virtual DbSet<TransactionDiary> TransactionDiaries { get; set; }
    }
}
